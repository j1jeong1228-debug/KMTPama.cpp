...
static const std::map<llm_tensor, llm_tensor_info> LLM_TENSOR_INFOS = {
    ...
    {LLM_TENSOR_ASSIST_PRE_PROJ,            {LLM_TENSOR_LAYER_INPUT,     GGML_OP_MUL_MAT}},
    {LLM_TENSOR_ASSIST_POST_PROJ,           {LLM_TENSOR_LAYER_OUTPUT,    GGML_OP_MUL_MAT}},
    {LLM_TENSOR_ASSIST_PRE_PROJ_DOTTED,     {LLM_TENSOR_LAYER_INPUT,     GGML_OP_MUL_MAT}},
    {LLM_TENSOR_ASSIST_POST_PROJ_DOTTED,    {LLM_TENSOR_LAYER_OUTPUT,    GGML_OP_MUL_MAT}},
    {LLM_TENSOR_ASSIST_PRE_PROJ_NEXTN,      {LLM_TENSOR_LAYER_INPUT,     GGML_OP_MUL_MAT}},
    ...
    {LLM_TENSOR_ASSIST_TOKEN_ORDERING,      {LLM_TENSOR_LAYER_OUTPUT,    GGML_OP_GET_ROWS}},
    // Nemotron 3 Super
