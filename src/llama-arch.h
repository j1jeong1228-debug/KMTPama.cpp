...
enum llm_tensor {
    ...
    LLM_TENSOR_ASSIST_PRE_PROJ,
    LLM_TENSOR_ASSIST_POST_PROJ,
    LLM_TENSOR_ASSIST_PRE_PROJ_DOTTED,
    LLM_TENSOR_ASSIST_POST_PROJ_DOTTED,
    LLM_TENSOR_ASSIST_PRE_PROJ_NEXTN,
    LLM_TENSOR_ASSIST_POST_PROJ_NEXTN,
    LLM_TENSOR_ASSIST_EMBED_CENTROIDS,
    LLM_TENSOR_ASSIST_TOKEN_ORDERING,
};
